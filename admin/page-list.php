...
function link_list_page(): void {
	...
	$group_colors = array_map( function ( $ug_name ) {
		return lnb_get_group_colors( $ug_name );
	}, $unique_groups );
	?>
				...
				foreach ( $links as $link ):
                    ...
                    <tr style="background-color: <?= $background_color; ?>;">
						...
						<?php if ( $link->group_id !== $last_group_id ): ?>
                            ...
                            >
                                <strong <?php if ( $link->group_disabled ) {
									echo 'class="text-strikethrough" ';
								} ?>>
									<?= esc_html( $link->group_name ); ?>
                                </strong>
                            </td>
                        ...
                        <!-- Name -->
                        <td>
                            <div class="color-block <?= empty( $link->color ) ? 'hollow' : '' ?>"
